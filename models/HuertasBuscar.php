...
use app\models\Huertas;

/**
 * HuertasBuscar represents the model behind the search form of `app\models\Huertas`.
 */
class HuertasBuscar extends Huertas
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['nombre', 'estado', 'ciudad', 'colonia', 'calle', 'numero', 'codigo_postal', 'comunidad', 'latitud', 'longitud', 'poligono', 'fecha', 'timestamp'], 'safe'],
        ];
    }
