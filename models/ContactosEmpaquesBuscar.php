...
/**
 * ContactosEmpaquesBuscar represents the model behind the search form of `app\models\ContactosEmpaques`.
 */
class ContactosEmpaquesBuscar extends ContactosEmpaques
{
    /**
     * {@inheritdoc}
     */
