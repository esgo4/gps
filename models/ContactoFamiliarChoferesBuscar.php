...
/**
 * ContactoFamiliarChoferesBuscar represents the model behind the search form of `app\models\ContactoFamiliarChoferes`.
 */
class ContactoFamiliarChoferesBuscar extends ContactoFamiliarChoferes
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = ContactoFamiliarChoferes::find();
