...
/**
 * BasculasBuscar represents the model behind the search form of `app\models\Basculas`.
 */
class BasculasBuscar extends Basculas
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['nombre', 'estado', 'ciudad', 'colonia', 'calle', 'numero', 'codigo_postal', 'comunidad', 'latitud', 'longitud', 'area_telefono', 'telefono', 'extension', 'email', 'fecha', 'timestamp'], 'safe'],
        ];
    }
